...
- The `sheets` config argument now allows for wildcard-based searches of sheets, enabling the creation of dynamic tables as needed. ([#32](https://github.com/turbot/steampipe-plugin-googlesheets/pull/32))
